...
namespace TCP_Chat_Room
{
    public partial class Client : Form
    {
        ...
        private void btnPrivate_Click(object sender, EventArgs e)
        {
            ...
            {
                Main_Server.SendPrivateMessage(txtName.Text, txtFriend.Text, txtMessFriend.Text);
        ...
        private void btnDisconnect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Connected)
                {
                    Main_Server.SendMyMessage(Username + " đã rời khỏi cuộc trò chuyện.\n");
                }
                listBoxClients.Items.Remove(Username);
                if (srReceiver != null)
                {
        ...
        {
            Main_Server server = new Main_Server(ip);
